...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BDItf5m5.mjs");
...
var manifest = { "5d2f684ffb1e01f066fae9f45c56e7e9fabc7a84bc9a894683d3b8bbe7023f19": {
	functionName: "shapeRecap_createServerFn_handler",
	importer: () => import("./reconnect-ai-B_pTt6Q5.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BhUcEtEs.mjs").then((n) => n.t),
