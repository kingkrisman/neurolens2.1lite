...
import { F as PanelWell, N as Panel, P as PanelHeader, b as ScrollScene, p as Button, y as PageEnter, z as cn } from "./router-DpF9KtHP.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { B as simulatedContrast, C as NAMED_PRESETS, D as SCHEME_TOKENS, E as RHYTHM_CHOICES, F as isHexColor, H as uiContrastPass, I as isLargeText, L as linearizeChannel, N as formatContrastRatio, P as hueDistinctionLost, R as normalizeHex, S as FONT_CLASS, T as READING_PROFILES, U as useAppStore, V as textContrastLevel, _ as Switch, a as AccessibleBionic, c as SchemePicker, g as Slider, h as Label, i as processBionicText, j as describePair, m as Input, n as FIXATION_PRESETS, o as FontPicker, p as Segmented, r as nearestFixationPreset, s as ContrastMeter, x as CVD_HINTS, y as DEMO_SENTENCE, z as simulateHex } from "./routes-tWvz_YTN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-panel-BPLiLv_J.js
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollScene, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelHeader, {
							...
							children: Object.keys(READING_PROFILES).map((id) => {
								const selected = mode === id;
								return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									"aria-pressed": selected,
									onClick: () => setMode(id),
									className: cn("min-w-0 rounded-md px-3 py-3 text-left text-sm font-medium text-pretty whitespace-normal transition-[background-color,transform] duration-[140ms] ease-[var(--ease-out)] active:scale-[0.97]", selected ? "bg-fg text-primary-fg" : "hover:bg-fg/8"),
