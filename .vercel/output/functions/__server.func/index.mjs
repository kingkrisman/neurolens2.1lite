...
var grokOgIdentity = { "site": {
	...
	"type": "website",
	"card": "custom",
	"description": "A calmer, more accessible reading experience for ADHD, dyslexia, and cognitive fatigue.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_nflETJ = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_nflETJ
	};
	return ((_m, p) => {
		return {
			data,
